...
function (t, i, e) {
    ...
    o.prototype = new n.L2DBaseModel,
        ...
        o.prototype.hitTestCustom = function (t, i, e) {
            if (void 0 != h.
                default.hit_areas_custom_head_x && void 0 != h.
                    default.hit_areas_custom_head_y) return "head" == t ? this.hitTestSimpleCustom(h.
...
function (t, i, e) {
    ...
    r.prototype.loadModelSetting = function (t, i) {
        ...
        r.prototype.getTextureFile = function (t) {
            // Texture传送门：自定义路径，随机获取服装
            return this.json[this.TEXTURES][0] + [Math.floor(Math.random() * this.json[this.TEXTURES][1])] + ".png"
        },
...
window.addEventListener("DOMContentLoaded", function () {
    var canvasLive2d = document.createElement("canvas");
    canvasLive2d.id = "live2d";
    canvasLive2d.width = 400;
    canvasLive2d.height = 300;
    canvasLive2d.style.position = "fixed";
    canvasLive2d.style.bottom = 0;
    canvasLive2d.style.right = 0;
    document.body.appendChild(canvasLive2d);
    if (canvasLive2d.addEventListener) {
        canvasLive2d.addEventListener("click", mouseEvent, false);
        canvasLive2d.addEventListener("mousedown", mouseEvent, false);
        canvasLive2d.addEventListener("mouseup", mouseEvent, false);
        canvasLive2d.addEventListener("mousemove", mouseEvent, false);
    }
    ...
    function mouseEvent(e) {
        ...
        if (e.type == "mousedown") {
            ...
            isDragging = true;
            mouseOffsetx = e.pageX - canvasLive2d.offsetLeft;
            mouseOffsety = e.pageY - canvasLive2d.offsetTop;
        }
        else if (e.type == "mousemove") {
            if (isDragging == true) {
                var movex = e.pageX - mouseOffsetx;
                var movey = e.pageY - mouseOffsety;
                if (movex > window.innerWidth - canvasLive2d.width)
                    movex = window.innerWidth - canvasLive2d.width;
                if (movex < 0) movex = 0;
                if (movey > window.innerHeight - canvasLive2d.height)
                    movey = window.innerHeight - canvasLive2d.height;
                if (movey < 0) movey = 0;
                canvasLive2d.style.left = movex + "px";
                canvasLive2d.style.top = movey + "px";
            }
        }
    ...
    loadlive2d("live2d", "./assets/live2d/model.json");
})