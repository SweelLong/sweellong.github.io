window.addEventListener("DOMContentLoaded", async function () {
  ...
  obj.style = "background-image: url('https://cdn.jsdelivr.net/gh/SweelLong/sweellong.github.io/assets/img/overlay.png?v=" + new Date().getTime() + "'), url('https://cdn.jsdelivr.net/gh/SweelLong/sweellong.github.io/assets/img/bg/" + cnt + ".jpg'" + new Date().getTime() + ")";
  // 动态插入推荐资源
